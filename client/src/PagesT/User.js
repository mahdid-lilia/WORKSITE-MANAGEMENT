...
export default function MiniDrawer() {
  ...
  return (
    <Box sx={{ display: 'flex' ,  height: '100%'   }} bgcolor="default" backgroundColor='#c2c2c2'>
      <CssBaseline />
      <AppBar position="fixed" open={open} color="default" style={style} >
        <Toolbar>
          <IconButton
            color="inherit"
          ...
          <IconButton size="large" aria-label="show 4 new mails" color="inherit">
          <Badge badgeContent={4} color="error"> {/*The number of notification */}
                <Avatar alt="Remy Sharp" sx={{ bgcolor: 'coral' }}  src='user/src/Assets/img/pics2.png'  />
          </Badge>
        </IconButton>

        </Toolbar>
      </AppBar>
      <Drawer variant="permanent" open={open}    bgColor='default'  containerStyle={{backgroundColor: '#e2e2e2'}}   >
        <Box >
