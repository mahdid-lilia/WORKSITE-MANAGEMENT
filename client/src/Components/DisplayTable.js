...
const DisplayTableOuvriers = () => {
  ...
  const [TelephoneOuvrier, setTelephoneOuvrier] = useState(undefined);
  const [Email, setEmail] = useState(undefined);
  const [motdePasse, setmotdePasse] = useState(undefined);
  ...
  const addOuvrier = () => {
    Axios.post("http://localhost:8000/create", {
      ...
      TelephoneOuvrier: TelephoneOuvrier,
    ...
    <Container >
      <div className="ouvriers">
        ...
        <Button
          ...
          onClick={() => document.location.href = '/Ouvrierli'} >Ajouter un Ouvrier</Button>
            ...
            <TableBody>
              {OuvrierList.map((val, key) => (
                <StyledTableRow key={val.idOuvrier}>
                  ...
                  <StyledTableCell className={classes.StyledTableCell} align="center" ><Button   onClick={() => {
                    deleteOuvrier(val.idOuvrier);
                  }} variant="outlined"  >Supprimer</Button></StyledTableCell>
                </StyledTableRow>
